...
local DeterminateProgress = Roact.Component:extend("DeterminateProgress")
DeterminateProgress.defaultProps = {}
...
function DeterminateProgress:init()
	self:setState({
		progress = 0,
		time = 0,
	})
...
function DeterminateProgress:didMount()
	self.isMounted = true
...
function DeterminateProgress:willUnmount()
...
function DeterminateProgress:render()
