...
function Shadow:willUpdate(nextProps)
	...
	animation[1] = RoactAnimate(self.state._umbraTransparency, SHADOW_TWEEN_INFO, shadowProps.Umbra.Transparency)
	animation[2] = RoactAnimate(self.state._umbraSize, SHADOW_TWEEN_INFO, UDim2.new(1, shadowProps.Umbra.Blur, 1, shadowProps.Umbra.Blur))
	animation[3] = RoactAnimate(self.state._umbraPosition, SHADOW_TWEEN_INFO, CENTER_UDIM2 + (shadowProps.Umbra.Offset or EMPTY_UDIM2))
	animation[4] = RoactAnimate(self.state._penumbraTransparency, SHADOW_TWEEN_INFO, shadowProps.Penumbra.Transparency)
	animation[5] = RoactAnimate(self.state._penumbraSize, SHADOW_TWEEN_INFO, UDim2.new(1, shadowProps.Penumbra.Blur, 1, shadowProps.Penumbra.Blur))
	animation[6] = RoactAnimate(self.state._penumbraPosition, SHADOW_TWEEN_INFO, CENTER_UDIM2 + (shadowProps.Penumbra.Offset or EMPTY_UDIM2))
	animation[7] = RoactAnimate(self.state._ambientTransparency, SHADOW_TWEEN_INFO, shadowProps.Ambient.Transparency)
	animation[8] = RoactAnimate(self.state._ambientSize, SHADOW_TWEEN_INFO, UDim2.new(1, shadowProps.Ambient.Blur, 1, shadowProps.Ambient.Blur))
	animation[9] = RoactAnimate(self.state._ambientPosition, SHADOW_TWEEN_INFO, CENTER_UDIM2 + (shadowProps.Ambient.Offset or EMPTY_UDIM2))
